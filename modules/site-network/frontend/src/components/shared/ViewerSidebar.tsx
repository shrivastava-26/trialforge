...
const navItems = [
  { label: 'Dashboard', path: '/viewer/dashboard', icon: <DashboardIcon fontSize="small" /> },
  { label: 'Studies',   path: '/viewer/studies',   icon: <ScienceIcon fontSize="small" /> },
  { label: 'Sites',     path: '/viewer/sites',     icon: <LocationOnIcon fontSize="small" /> },
  { label: 'Examiners', path: '/viewer/examiners', icon: <PersonSearchIcon fontSize="small" /> },
  { label: 'Search',    path: '/viewer/search',    icon: <SearchIcon fontSize="small" /> },
];
